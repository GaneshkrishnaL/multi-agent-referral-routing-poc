...
if __name__ == "__main__":
    ...
    if args.model not in MODEL_DATA or args.tuning_mode not in MODEL_DATA[args.model]:
        print(
    ...
    cost = calculate_cost(character_count, args.model, args.tuning_mode, args.epochs)
